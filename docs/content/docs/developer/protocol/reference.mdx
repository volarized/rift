...
[`rift://workspace`](/docs/mcp#resource-workspace),
[`rift://logs`](/docs/mcp#resource-logs), and
[`rift://map`](/docs/mcp#resource-map) - is defined in the Rust models and appears in
